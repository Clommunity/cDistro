...
addS("docker_button_install", "Instal·la Docker (docker.io)");
...
addS("docker_button_uninstall", "Desinstal·la Docker (docker.io)");
addS("docker_button_container_publish", "Publica");
addS("docker_button_container_pull", "Obtingues la image");
addS("docker_button_container_stop", "Atura");
...
addS("docker_button_image_confrun", "Configura i engega");
addS("docker_button_image_rmi", "Esborra");
